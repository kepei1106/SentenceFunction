  ...
  with ops.name_scope(name, "dynamic_rnn_decoder",
    ...
    def loop_fn(time, cell_output, cell_state, loop_state):
      ...
      if inputs is not None:  # training
        ...
        # next_context_state, current_type) = decoder_fn(time, cell_state, next_cell_input,
        ...
        (next_done, next_cell_state, next_cell_input, emit_output,
         next_context_state, current_type) = decoder_fn(time, cell_state, None, cell_output,
                                          context_state)
      ...
      return (next_done, next_cell_input, next_cell_state,
              #emit_output, next_loop_state, current_type)
              emit_output, next_loop_state)

    # Run raw_rnn function
    #outputs_ta, final_state, final_loop_state, output_type = rnn.raw_rnn(
    ...
    #outputs_type = output_type.stack()
    ...
    if not time_major:
      ...
      #outputs_type = array_ops.transpose(outputs_type, perm=[1, 0, 2])
    #return outputs, final_state, final_context_state, outputs_type
